...
function HISFooter({ simplifiedMode = false, onToggleMode }) {
  return (
    <footer className="his-footer">
      ...
      <div className="his-footer-toggle">
        <label className="his-toggle-label">
          <span className="his-toggle-text">Simplified</span>
          <input 
            type="checkbox" 
            checked={simplifiedMode}
            onChange={onToggleMode}
            className="his-toggle-input"
          />
          <span className="his-toggle-slider"></span>
        </label>
      </div>
    </footer>
  )
